    ...
    cout << "\nWellcome to X-AIRLINE home page !! "<<endl;     
     ...
     invalid_choise_1: //label for invalid choise.
        cin >> choise;
              ...
              if (choise[1]!='\0'){                  //Error handle when more than enters more than one character. 
    ...
    switch (choise[0])
    {
        case '1':     //assigning seat section.
         ...
         invalid_choise_2: //Label for invalid class choise.
             cin >> class_choise;
                if (class_choise[1]!='\0'){                  //Error handle when more than enters more than one character. 
                    cout << "Please enter a valid input again: ";
                    goto invalid_choise_2;
                }   
                if (class_choise[0]!='1' && class_choise[0] !='2' && class_choise[0] !='3'){       //error handling when choise is different from 1 or 2.
                    cout << "Please enter a valid input again: ";
                    goto invalid_choise_2;
                }
                ...
                first_class:
                    if (fcc>30){     
                     ...
                     invalid_choise_3:    //label for invalid yes or no choise 
                        cin >>y_or_n;
                           if (y_or_n[1]!='\0'){                  //Error handle when more than enters more than one character. 
                              cout << "Please enter a valid input again: ";
                              goto invalid_choise_3;
                            }

                         y_or_n[0]=toupper(y_or_n[0]);  
                        if (y_or_n[0]=='Y'){goto economy_class;} 
                        else if (y_or_n[0]=='N'){
                        ...
                        cin>>passport_num[fcc];
                         ...
                         cin >> y_or_n;
                             if (y_or_n[1]!='\0'){                  //Error handle when more than enters more than one character. 
                                ...
                                y_or_n[0]=toupper(y_or_n[0]);
                            if (y_or_n[0]=='Y'){goto assign_person;}
                            else {goto homepage;}    
                     }
                    ...
                    invalid_choise_5: //label for invalid yes or no choise    
                        cin >>y_or_n;
                           if (y_or_n[1]!='\0'){                  //Error handle when more than enters more than one character. 
                              ...
                              y_or_n[0]=toupper(y_or_n[0]);
                        if (y_or_n[0]=='Y'){goto first_class;} 
                        else if (y_or_n[0]=='N'){
                            cout<< "The next flight leaves in 3 hours!!\n";
                            cout<< "-----------------------------------\n";
                            goto homepage;
        ...
        case '2':          //Displaying option.  
         ...
         displaying_position:    
             ...
             invalid_choise_7:     
                 cin >> display;   
                      if (display[1]!='\0'){                  //Error handle when more than enters more than one character. 
                    cout << "Please enter a valid input again: ";
                    goto invalid_choise_7;
                }   
                 if (display[0]!='1' && display[0] !='2' && display[0] !='3'){       //error handling when choise is different from 1 or 2 or 3.
                    cout << "Please enter a valid input again: ";
                    goto invalid_choise_7;
                }
                           ...
                           for (i=1; i<=100; i++)
                               {
                                 ...
                                 if (search_passport_num == passport_num[i])   //Searching code.
                                  ...
                                  if (i>100){         //Out put when their is no person with such passport number.
                                      cout << "--------------------------------------------------------------"<<endl;
