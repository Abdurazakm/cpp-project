...
int main()
{
    ...
    int i, fcc = 11, ecc = 31;                                   // ecc=economy class count  ,fcc=first class count.
...
invalid_choise_1: // label for invalid choise.
    cin.getline(choise, 10);
    if (choise[1] != '\0'|| isspace(choise[1]) )
    ...
    invalid_choise_2: // Label for invalid class choise.
        ...
        first_class:
            ...
            invalid_age_1:
                ...
                for (i = 0; i < fcc; i++)
                {
                    if (passport_num[fcc] == passport_num[i]) // to check assign seat befor in the first class.
                    {
                        cout << "\n---------------------------------\n";
                        cout << "ALREADY ASIGNED IN THE FIRST CLASS" << endl;
                        cout << "---------------------------------\n";
                        cin.ignore();
                        goto homepage;
                    }
                ...
                for (i = 30; i < ecc; i++)
                {
                    if (passport_num[fcc] == passport_num[i]) // to check assign seat befor in the economy class.
                    {
                        cout << "\n---------------------------------\n";
                        cout << "ALREADY ASIGNED IN THE ECONOMY CLASS" << endl;
                        cout << "---------------------------------\n";
                        cin.ignore();
                        goto homepage;
                    }
                ...
                cout << "|____________________|_______|____________________|_____________|" << endl;
                if (fcc < 10) // we use this if condition to display seat number like 001,002...009.
                {
                    x = '0';
                    y = '0';
                }
                else if (fcc >= 10 && fcc < 31) // we use this else if condition to display seat number like 011,012...030.
                {
                    x = '0';
                    z = ' ';
                }
                cout << "|" << setw(20) << left << name[fcc];
                cout << "|" << setw(7) << left << sex[fcc];
                cout << "|" << setw(20) << left << passport_num[fcc]; // Displaying all first class assigned persons.
                cout << "|" << setw(1) << left << x;
                cout << setw(1) << left << y;
                cout << setw(11) << left << fcc;
                cout << setw(1) << left << z;
                cout << "|" << endl;
                cout << " -------------------------------------------------------------- " << endl;
                ++fcc;
        ...
        economy_class:
            ...
            invalid_age_2:
                ...
                for (i = 0; i < fcc; i++)
                {
                    if (passport_num[ecc] == passport_num[i]) // to check assign seat befor in the first class.
                    {
                        cout << "\n---------------------------------\n";
                        cout << "ALREADY ASIGNED IN THE FIRST CLASS" << endl;
                        cout << "---------------------------------\n";
                ...
                for (i = 30; i < ecc; i++)
                {
                    if (passport_num[ecc] == passport_num[i]) // to check assign seat befor in the economy class.
                    {
                        cout << "\n---------------------------------\n";
                        cout << "ALREADY ASIGNED IN THE ECONOMY CLASS" << endl;
                        cout << "---------------------------------\n";
                ...
                if (ecc < 100) // we use this if condition to display seat number like 031,032...099.
                {
                    x = '0';
                }
                else if (ecc == 100)
                ...
                cout << "|" << setw(7) << left << sex[ecc];
                cout << "|" << setw(20) << left << passport_num[ecc]; // Displaying all economy class assigned persons.
                cout << "|" << setw(2) << left << x << "\b";
                cout << setw(11) << left << ecc << "|";
                cout << endl;
                cout << " -------------------------------------------------------------- " << endl;
                ++ecc;
                cout << "If you want to add again press 'Y' OR any single character key to go to home page: ";
